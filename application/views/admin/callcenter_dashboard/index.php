...
<div id="wrapper">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <h4 class="tw-mb-4"><?php echo _l('call_center_lead_dashboard'); ?></h4>
      </div>
    </div>

    <div class="row">
      <div class="col-md-12">
        <?php $this->load->view('admin/custom_widgets/cc_dashboard', ['team_data' => $team_data]); ?>
      </div>
    </div>
...
<script>
  jQuery(document).ready(function ($) {
    function loadTeamSummary(fromDate) {
      $.post(admin_url + 'call_center_dashboard/ajax_callcenter_summary', {
        from_date: fromDate
      }).done(function (res) {
