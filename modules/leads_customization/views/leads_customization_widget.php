    ...
    <div class="panel_s user-data">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <p class="text-dark text-uppercase bold"><?php echo _l('closed_leads_report'); ?></p>
                    </div>
                    <div class="col-md-3">
                        <?php
                        echo render_select('service', [], ['id', 'name'], 'services', '', ['data-width' => '100%', 'data-none-selected-text' => _l('services')], [], 'no-mbot');
                        ?>
                    </div>
                    <div class="col-md-3">
                ...
                <hr class="mtop15"/>
                <div class="col-md-12">
                    <table class="table table-closed_leads_report dt-table scroll-responsive">
                        <thead>
