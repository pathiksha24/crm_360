...
<div class="<?php if ($openEdit == true) {
    ...
    <div class="row">
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        ...
                        <?php echo _l('lead_add_edit_whatsapp_number'); ?></dt>

                    <dd class="tw-text-neutral-900 tw-mt-1">

                        <?php echo (isset($lead) && $lead->whatsapp_number != '' ? '<a href="tel:' . $lead->whatsapp_number . '">' . $lead->whatsapp_number . '</a>' : '-') ?>
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        ...
                        <?php echo _l('lead_add_edit_service'); ?></dt>

                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">

                        <?php echo (isset($lead) && $lead->service_name != '' ? $lead->service_name : '-') ?></dd>

                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">

                        <?php echo _l('lead_add_edit_language'); ?></dt>

                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">

                        <?php echo (isset($lead) && $lead->language_name != '' ? $lead->language_name : '-') ?></dd>
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <div class="col-md-4 <?php if (!isset($lead)) {
                                        echo ' hide';
                                    } ?>">
                ...
                if ($selected == '') $selected = $default_status;
            ...
            <div class="col-md-4">
                ...
                <div class="form-group" app-field-wrapper="assigned">
                    <label for="assigned" class="control-label"><?= _l('lead_add_edit_assigned'); ?></label>
                    <select id="assigned" <?= $disabled ?> name="assigned" class="selectpicker" data-width="100%" data-none-selected-text="<?= _l('dropdown_non_selected_tex') ?>" data-live-search="true" tabindex="-98">
                        <option value=""></option>
                        <?php foreach ($members as $member) { ?>
                            <option <?= ($member['staffid'] == $selected ? 'selected' : '') ?> value="<?= $member['staffid'] ?>"><?= $member['status'] == 1 ? '🟢' : '🟡' ?> <?= $member['firstname'] . ' ' . $member['lastname'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <?php echo render_input('phonenumber', 'lead_add_edit_phonenumber', $value, 'number'); ?>

                <?php

                $value = (isset($lead) ? $lead->whatsapp_number : ''); ?>

                <?php echo render_input('whatsapp_number', 'lead_add_edit_whatsapp_number', $value, 'number'); ?>
            ...
            <div class="col-md-12">
                ...
                if (is_admin()) echo render_textarea('description', 'lead_description', $value);
...
<script>
    $(function() {
        ...
        $('#whatsapp_number').on('keypress', function() {
        ...
        $('#whatsapp_number').on('paste', function(event) {
