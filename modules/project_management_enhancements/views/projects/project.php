                        ...
                        <div role="tabpanel" class="tab-pane active" id="tab_project">
                            ...
                            <div class="form-group select-placeholder">
                                <div>
									...
									{
										foreach ($project_owners as $owner)
										{
											array_push($selected, $owner['staff_id']);
										}
									} else
									{
									...
									echo render_select(
										...
										'project_owners',
										$selected,
										['multiple' => TRUE, 'data-actions-box' => TRUE, 'required' => TRUE],
										[],
										'',
										'',
										FALSE
											...
											<?php foreach (get_project_tabs_admin() as $tab)
											{
                                                    ...
                                                    <optgroup
														...
														<?php foreach ($tab['children'] as $tab_dropdown)
														{
                                                            ...
                                                            <option
																...
																<?= e($selected); ?><?php if (isset($tab_dropdown['linked_to_customer_option']) && is_array(
																	$tab_dropdown['linked_to_customer_option']
																) && count($tab_dropdown['linked_to_customer_option']) > 0)
															{ ?>
												...
												<?php } else
												{
                                                    ...
                                                    <option
														...
														<?= e($selected); ?>
														<?php if (isset($tab['linked_to_customer_option']) && is_array($tab['linked_to_customer_option']) && count(
																$tab['linked_to_customer_option']
															) > 0)
														{ ?>
