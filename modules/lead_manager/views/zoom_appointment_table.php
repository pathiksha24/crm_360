...
foreach ($rResult as $aRow) {
    ...
    $row[] = $outputStatus;
    $remarkadd_fields='<a href="javascript:void(0);"><i class="fa fa-file-text" aria-hidden="true" onclick="saveMeetingRemark('.$aRow['id'].',2);"></i></a>&nbsp;&nbsp;<a href="javascript:void(0);"><i class="fa fa-eye" aria-hidden="true" onclick="showMeetingRemark('.$aRow['id'].',2);"></i></a>';
