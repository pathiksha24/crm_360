...
<h4 class="customer-profile-group-heading"><?php echo _l('lm_mailbox_cofiguration_title'); ?></h4>
<div class="panel_s">
	<div class="panel-body">
		<h4 class="customer-profile-group-heading"><?php echo _l('lm_mb_smtp_config_heading'); ?></h4>
		<form id="mailbox-config-form">
			...
			<div class="row">
				<div class="col-md-6">
					...
					echo render_input('smtp_port',_l('lm_mb_smtp_port_field'),$value); 
					?>
				</div>
				<div class="col-md-6">
					<?php 
			...
			<hr class="hr-panel-heading"></hr>
			<h4 class="customer-profile-group-heading"><?php echo _l('lm_mb_imap_config_heading'); ?></h4>
			<div class="row">
				<div class="col-md-6">
					<?php 
		...
		<div class="text-right">
			<button class="btn btn-success" onclick="submitMailboxConfig(this);">Save</button>
		</div>
	</div>
</div>