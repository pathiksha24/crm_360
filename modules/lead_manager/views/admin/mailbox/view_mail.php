                       ...
                       <div class="col-md-1">
                          <div>
                             <a class="border-right" href="javascript:void(0);" data-id="<?php echo $mail->id; ?>" data-param="<?php echo $mail->is_favourite ? 'unstar' : 'unstar'; ?>" onclick="lm_mb_view_mail_action(this); return false;">
                               <?php echo $mail->is_favourite ? '<i class="fa fa-star text-warning" aria-hidden="true"></i>' : '<i class="fa fa-star text-muted" aria-hidden="true"></i>'; ?>
                            </a>
                         </div>
                      </div>
                      <div class="col-md-1">
                        <a class="border-right" href="javascript:void(0);" data-id="<?php echo $mail->id; ?>" data-param="<?php echo $mail->is_bookmark ? 'unbookmark' : 'bookmark'; ?>" onclick="lm_mb_view_mail_action(this); return false;">
                          <?php echo $mail->is_bookmark ? '<i class="fa fa-bookmark" aria-hidden="true"></i>' : '<i class="fa fa-bookmark text-muted" aria-hidden="true"></i>'; ?>
                       </a>
                    </div>
                    <div class="col-md-1">
       ...
       <div class="mail_header_title">
        <div class="row">
         ...
         <div class="col-md-6">
          <div class="newer_older_cl">
             <div>
                <?php echo date('h:i',$mail->mail_date); $mail_date = date('Y-m-d h:i:s',$mail->mail_date); ?>
                (<small title="<?php echo _dt($mail_date); ?>"><?php echo time_ago($mail_date); ?></small>)
             </div>
             <div>
     ...
     <form id="mailbox-draft-form" action="<?php echo admin_url('lead_manager/mailbox_mail_reply'); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="mail_rply_cl mbot5 text-right">
            <button id="draft-mailbox-btn" class="btn mright5 btn-info pull-right display-block" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off"><?php echo _l('send'); ?> <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
         </div>
      </div>
   </form>
</div>
               ...
               foreach($attachments as $attachment){
                ...
                <div class="col-lg-4">
                   <div class="card text-center inner_atch_wrpa">
                    <div class="card-body">
                     <p class="card-text"><?php $icon = get_file_icons($attachment['filetype']); echo $icon; ?></p>
                  </div>
...
<div class="row hide" id="reply-div">
   <form id="mailbox-reply-form" action="<?php echo admin_url('lead_manager/mailbox_mail_reply'); ?>" enctype="multipart/form-data">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="mail_rply_cl mbot5 text-right">
          <button id="reply-mailbox-btn" class="btn mright5 btn-info pull-right display-block" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off"><?php echo _l('send'); ?> <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
       </div>
    </div>
 </form>
</div>
<div class="row hide" id="forword-div">
   <form id="mailbox-forword-form" action="<?php echo admin_url('lead_manager/mailbox_mail_reply'); ?>" enctype="multipart/form-data">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="mail_rply_cl mbot5 text-right">
          <button id="forword-mailbox-btn" class="btn mright5 btn-info pull-right display-block" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off"><?php echo _l('send'); ?> <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
       </div>
    </div>
 </form>
</div>
